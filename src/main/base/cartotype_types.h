...
#if defined(__APPLE__) || (_MSC_VER >= 1600)
...
// Microsoft Visual C++
    ...
    /*
    Insist on a version of Microsoft Visual C++ no earlier than Visual Studio 2013,
    which has the internal version number 1800.
    */
    #if (_MSC_VER >= 1800)
    ...
    // Define _DEBUG if needed: Microsoft Embedded C++ defines DEBUG only, so TResult, etc., would be wrong
    ...
    #else
    #error CartoType needs Microsoft Visual Studio 2013 or later.
    #endif
...
#undef NULL // in case a C standard library header defining NULL has been included
#define NULL 0

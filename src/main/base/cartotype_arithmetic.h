...
class Arithmetic
    {
    public:
    static int32 MulDiv(int32 aA,int32 aB,int32 aC) noexcept;
    static void MulTo64(int32 aX,int32 aY,TInt64& aZ) noexcept;
    static void Add64(TInt64 aX,TInt64 aY,TInt64& aZ) noexcept;
    static int32 Div64By32(TInt64 aX,int32 aY) noexcept;
    ...
    static int32 Sqrt(int32 aValue) noexcept;
    static double Strtod(const char* aString,size_t aLength = UINT32_MAX,const char** aEndPtr = nullptr) noexcept;
    static double Strtod(const uint16* aString,size_t aLength = UINT32_MAX,const uint16** aEndPtr = nullptr) noexcept;
...
class TFixed
    ...
    void operator*=(TFixed aB)
        ...
        if (s > 0)
            iValue = int32((int64(iValue) * int64(aB.iValue) + 0x8000) >> 16);
        else
            iValue = int32(-((int64(iValue) * int64(aB.iValue) + 0x8000) >> 16));
        }

...
class MPath
    ...
    */
    ...
    TRect CBox() const;
    bool CBoxBiggerThan(int32 aSize) const;
    ...
    TResult GetHorizontalPath(int32 aDesiredWidth,TLine& aLine,const TRect* aBounds = nullptr,const TRect* aClip = nullptr) const;
...
class TContour: public MPath
    ...
    TPointFP PointAtLength(double aLength,double aOffset = 0,int32* aLineIndex = nullptr) const;
...
class CContour: public MPath, public MWritableContour
    ...
    */
    ...
    void MakePolygon(double aX,double aY,double aRadius,int32 aSides);

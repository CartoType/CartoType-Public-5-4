...
/** A TLineCap synonym for backward compatibility. @deprecated */
constexpr TLineCap ELineCapButt = TLineCap::Butt;
/** A TLineCap synonym for backward compatibility. @deprecated */
constexpr TLineCap ELineCapRound = TLineCap::Round;
/** A TLineCap synonym for backward compatibility. @deprecated */
constexpr TLineCap ELineCapSquare = TLineCap::Square;
...
/** A TLineJoin synonym for backward compatibility. @deprecated */
constexpr TLineJoin ELineJoinRound = TLineJoin::Round;
/** A TLineJoin synonym for backward compatibility. @deprecated */
constexpr TLineJoin ELineJoinBevel = TLineJoin::Bevel;
/** A TLineJoin synonym for backward compatibility. @deprecated */
constexpr TLineJoin ELineJoinMiter = TLineJoin::Miter;
...
class TTypefaceInstance
    {
    public:
    TTypefaceInstance(): iSize(12), iFlags(KAntiAlias) { }
    ...
    static constexpr uint32 KAntiAlias = 1;

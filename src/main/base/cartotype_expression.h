...
Copyright (C) 2009-2017 CartoType Ltd.
...
inline int32 TypeCode(char A,char B,char C) { return (((A-'a') << 27) | ((B-'a') << 22) | ((C-'a') << 17)); }
...
class MVariableDictionary
    ...
    virtual bool Find(int32 aIndex,TExpressionValue& aValue) const = 0;
    };
...
class CVariableDictionary: public MVariableDictionary
    ...
    bool Find(int32 /*aIndex*/,TExpressionValue& /*aValue*/) const override
        {
        return false;
        }

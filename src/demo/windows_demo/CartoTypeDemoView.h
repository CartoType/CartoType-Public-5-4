...
class CCartoTypeDemoView : public CView, public CartoType::MNavigatorObserver
{
...
protected:
    ...
    afx_msg void OnViewDrivingInstructions();
    afx_msg void OnUpdateViewDrivingInstructions(CCmdUI *pCmdUI);
...
private:
    ...
    void SimulateNavigationFix(double aDriveDistance,bool& aAtEnd);
    void StopFlyThrough();
    void CalculateAndDisplayRoute();
    void SetProfile(CartoType::TRouteProfileType aProfileType);

    void OnTurn(const CartoType::TNavigatorTurn& aFirstTurn,
                              const CartoType::TNavigatorTurn* aSecondTurn,
                              const CartoType::TNavigatorTurn* aContinuationTurn);
    void OnTurnRound();
    void OnNewRoute();
    void OnPositionKnown();
    void OnPositionUnknown();
    void OnAddNearbyObject(const CartoType::CMapObject* aObject,double aDistanceToRoute,double aDistanceAlongRoute);
    void OnUpdateNearbyObject(const CartoType::CMapObject* aObject,double aDistanceToRoute,double aDistanceAlongRoute);
    void OnRemoveNearbyObject(const CartoType::CMapObject* aObject);
    ...
    CartoType::CString iFirstTurnInstruction;
    CartoType::CString iSecondTurnInstruction;
    CartoType::CString iRemainingDistanceText;
    CartoType::TRouteProfileType iRouteProfileType = CartoType::ECarRouteProfile;
